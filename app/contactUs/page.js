...
function Contact() {
  return (
    <div>
      <section className="py-8 md:py-24 lg:py-36 bg-white overflow-hidden">
          ...
          <div className="flex flex-wrap -m-8">
            <div className="w-full md:w-1/2 p-8">
              <div className="md:max-w-md">
                ...
                <h3
                  className="mb-6 text-xl md:text-3xl font-semibold font-hanson"
                  style={{ letterSpacing: '-0.5px' }}
                >
                  &ldquo;Basko is a total game-changer! Streamlined workflow
                  &amp; productivity. Highly recommend!&rdquo;
                </h3>
                <h4 className="font-semibold tracking-tight mb-1 font-ubuntu">
                  Prince Porter
                </h4>
                <span className="font-ubuntu">CEO Platinum Discoveries.</span>
              </div>
            </div>
            <div className="w-full md:w-1/2 p-8">
              <form
              ...
              >
                ...
                <div className="w-full p-3">
                  <label className="block">
                    <textarea
                      className="w-full px-4 py-4 text-gray-700 tracking-tight placeholder-gray-700 outline-none border border-gray-700 focus:border-gray-400 rounded-lg transition duration-200"
                      id="contactInput1-5"
                      type="text"
                ...
                <div className="w-full p-3">
                  ...
                  <span className="text-sm text-gray-600 tracking-tight font-ubuntu">
                    * We get you closer step to your dreams.
                  </span>
                </div>
              </form>
            </div>
